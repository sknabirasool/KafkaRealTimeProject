...
public class CountTestMultipleTopicsScbscribe {

    private static final String BOOTSTRAP_SERVERS = "localhost:9092";
    private static final List<String> TOPICS = Arrays.asList(AppConfigs.topicName,AppConfigs.SOURCE_TOPIC);
    private static final String GROUP_ID_CONFIG = "consumerGroup1";
    private static final String SUMMARY_TOPIC = "my-summary-topic";
    ...
    public static void main(String[] args) {
        ...
        for (String topic : TOPICS) {
            ...
            for (PartitionInfo partitionInfo : partitionInfos) {
                ...
                producer.send(new ProducerRecord<>(SUMMARY_TOPIC, Integer.toString(partitionInfo.partition()), summaryMessage));
            }
        }
